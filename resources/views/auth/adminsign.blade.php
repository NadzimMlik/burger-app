    ...
    <section class="login-main-wrapper">
        <div class="container-fluid pl-0 pr-0">
            <div class="row no-gutters">
                <div class="col-md-5 p-5 bg-white align-items-center d-flex vh-100">
                    <div class="login-main-left">
                        <div class="text-center mb-5 login-main-left-header pt-4">
                            <img src="{{url('assets/img/favicon.png')}}" class="img-fluid" alt="LOGO">
                            <h5 class="mt-3 mb-3">Welcome to Here</h5>
                        ...
                        <div class="login-form">
                            ...
                            <div class="text-center mt-3">
                                <p class="light-gray">Don’t have an account? <a class="login-btn" href="{{ route('register.admin') }}">Sign Up</a></p>
                            </div>
                        </div>
                        ...
                        <div class="signup-form">
                            <form method="POST" action='{{ url("register/$url") }}' aria-label="{{ __('register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password_confirmation" required placeholder="Confirmation">
                                </div>
                                <div class="mt-4">
                            ...
                            <div class="text-center mt-5">
                                <p class="light-gray">Already have an Account? <a class="signup-btn" href="{{ route('login.admin') }}">Sign In</a></p>
                            </div>
                        </div>
                        @endif
                    </div>
                </div>
                <div class="col-md-7 align-items-center d-flex vh-100 hidden">
                    <div class="login-main-right bg-white p-5 mt-5 mb-5">
                        <div class="owl-carousel owl-carousel-login">
                            <div class="item">
                                <div class="carousel-login-card text-center">
                                    <img src="{{url('assets/img/login.png')}}" class="img-fluid" alt="LOGO">
